...
pub fn build(b: *std.Build) void {
    ...
    const shelly_key = b.dependency("shelly_key", .{
        .target = target,
        .optimize = optimize,
    });
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "Shelly_Rlpm" is the name you will use in your source code to
                // import this module (e.g. `@import("Shelly_Rlpm")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "Shelly_Rlpm", .module = mod },
                .{ .name = "Shelly_Key", .module = shelly_key.module("Shelly_Key") },
            },
        }),
    });
